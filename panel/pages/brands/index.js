...
const Index = () => {
  ...
  const [dataDeleted, deleteBrand] = useMutation(DELETE_BRAND)
  const [dataRemoveBrandLogo, deleteBrandLogo] = useMutation(REMOVE_BRAND_LOGO)
  ...
  return (
    <Layout>
      ...
      <Button.Link href='/brands/create'>Nova marca</Button.Link>

      <div className='flex flex-col mt-8'>
        <div className='-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8'>
          {data && data.getAllBrands && data.getAllBrands.length === 0 && (
            <Alert>Nenhuma marca cadastrada.</Alert>
          )}
