...
const MenuNavItem = ({ children, href, Icon }) => {
  ...
  const active =
    router.pathname === href
      ? 'text-gray-50 bg-gray-400 bg-opacity-25'
      : 'text-gray-500'
  //
  ...
  return (
    <Link href={href}>
      <a
        className={`flex items-center mt-4 py-2 px-6 border-l-4 border-gray-900  hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 ${active}`}
      >
